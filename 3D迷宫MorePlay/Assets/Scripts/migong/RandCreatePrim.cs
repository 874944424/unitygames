...
public class RandCreatePrim : MonoBehaviour
{
    ...
    */
    ...
    void Start()
    {
        ...
        CreatePrefabMap();
        widthLimit = PlayerPrefs.GetInt("Thebolder");
        heightLimit = PlayerPrefs.GetInt("Thebolder");
    }
    ...
    private void CreatePrefabMap()
    {
        ...
        node[,] map = MakeMazemap(startXY[0], startXY[1], widthLimit, heightLimit, widthLimit, heightLimit, CreateEmptyMazemap(widthLimit, heightLimit));
       //初始墙体 和 结束位子墙体
        //map[1, 0] = node.pass;
