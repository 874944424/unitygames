...
{	
  ...
  var preview_this : SerializedProperty;
  ...
  //var dynamicLayers : SerializedProperty;
    ...
    preview_this = serObj.FindProperty ("preview");
  ...
  function OnInspectorGUI () {         
    ...
    EditorGUILayout.PropertyField (preview_this, new GUIContent("Preview"));
    if (preview_this.boolValue)
